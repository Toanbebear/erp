...
class CollaboratorReportTransactionWizard(models.TransientModel):
    _name = 'collaborator.report.transaction.wizard'
    ...
    def create_report(self):
        ...
        report_brand_overview_attachment = self.env['ir.attachment'].browse(
            self.env.ref('collaborator.collaborator_report_transaction_wizard_attachment').id)
