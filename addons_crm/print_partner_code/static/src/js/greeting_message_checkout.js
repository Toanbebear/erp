odoo.define('patient.greeting_message_checkout', function (require) {
"use strict";
...
var GreetingMessage = AbstractAction.extend({
    contentTemplate: 'PtAttendanceGreetingMessageCheckout',
...
//        }
        ...
        if (this.next_action != 'patient.pt_attendance_action_kiosk_mode_checkout' && this.next_action.tag != 'pt_attendance_kiosk_mode_checkout') {
            this.activeBarcode = false;
        }
        ...
        if(this.attendance.check_in != "" || this.attendance.check_in != null)
        {
            this.attendance.check_in = this.attendance.check_in && moment.utc(this.attendance.check_in).local();

        }
        if (this.attendance.check_out != "" || this.attendance.check_out != null){
...
core.action_registry.add('pt_attendance_greeting_message_checkout', GreetingMessage);
