...
from openpyxl.styles import borders, Font, Alignment, PatternFill
    ...
    def _print_report(self, data):
        ...
        if self.print_excel:
            ...
            template = self.env['ir.attachment'].browse(
                self.env.ref('accounting_pdf_reports.report_general_ledger').id)
            ...
            ws['a1'].value = data['form']['company_id'][1]
            ...
            ws['a5'].value = display_account
            ws['a5'].border = all_border_thin
            ws['a5'].font = Font(name='Times New Roman', size=13, bold=True)
            ws['a5'].alignment = Alignment(wrap_text=True)
            ws['a7'].value = data['form']['target_move']
            ws['a7'].border = all_border_thin
            ws['a7'].font = Font(name='Times New Roman', size=13, bold=True)
            ws['a7'].alignment = Alignment(wrap_text=True)
            ws['a9'].value = sortby
            ws['a9'].border = all_border_thin
            ws['a9'].font = Font(name='Times New Roman', size=13, bold=True)
            ws['a9'].alignment = Alignment(wrap_text=True)
            row = 11
            for vals in accounts_res:
                index = 1
