...
//        );
    ...
    leaves_request_month: function(e) {
        ...
        this.do_action({
            ...
            view_mode: 'tree,form,calendar',
            views: [[false, 'list'],[false, 'form']],
            domain: [['date_from','>', fday],['state','=','validate'],['date_from','<', lday], ['employee_id','=', this.login_employee.id]],
            target: 'current'
        }, options)
    },
    ...
    leaves_request_today: function(e) {
        ...
        this.do_action({
            ...
            view_mode: 'tree,form,calendar',
            views: [[false, 'list'],[false, 'form']],
            domain: [['date_from','<=', date], ['date_to', '>=', date], ['employee_id','=', this.login_employee.id]],
            target: 'current'
        }, options)
    },
    leaves_to_approve: function(e) {
        ...
        this.do_action({
            ...
            view_mode: 'tree,form,calendar',
            views: [[false, 'list'],[false, 'form']],
            domain: [['state','in',['confirm','validate1']], ['employee_id','=', this.login_employee.id]],
            target: 'current'
        }, options)
    },
