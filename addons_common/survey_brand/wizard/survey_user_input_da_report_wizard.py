...
class SurveyUserInputWizard(models.TransientModel):
    _name = 'survey.user.input.da.report.wizard'
    _description = 'Báo cáo khảo sát Đông Á'
    ...
    brand_id = fields.Many2one('res.brand', default=lambda self: self.env['res.brand'].browse(2))
    ...
    survey_id = fields.Many2one('survey.survey', domain="[('brand_id', '=', brand_id)]")
